...
public interface JetWhaleMethodAgentPluginProtocol<Event, Method, MethodResult> {
...
@PublishedApi
internal class KotlinxSerializationJetWhaleMethodAgentPluginProtocol<Event, Method, MethodResult>(
...
) : JetWhaleMethodAgentPluginProtocol<Event, Method, MethodResult> {
...
public inline fun <reified Event : Any, reified Method : Any, reified MethodResult : Any> kotlinxSerializationJetWhaleMethodAgentPluginProtocol(
    json: Json = JetWhaleJson,
): JetWhaleMethodAgentPluginProtocol<Event, Method, MethodResult> = KotlinxSerializationJetWhaleMethodAgentPluginProtocol(
    json = json,
