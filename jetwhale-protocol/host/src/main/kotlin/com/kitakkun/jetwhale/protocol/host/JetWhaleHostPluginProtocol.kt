...
public inline fun <reified Event : Any, reified Method : Any, reified MethodResult : Any> kotlinxSerializationJetWhaleHostPluginProtocol(json: Json): JetWhaleHostPluginProtocol<Event, Method, MethodResult> {
