...
/**
 * Method-based plugin interface for JetWhale Host.
 * Supports request-response communication via Method and MethodResult types.
 *
 * For simple bidirectional fire-and-forget event communication, use [JetWhaleHostPlugin] instead.
 */
public abstract class JetWhaleMethodHostPlugin<Event, Method, MethodResult> : JetWhaleRawHostPlugin() {
    /**
     * The protocol used for encoding and decoding events, methods, and method results
     */
    protected abstract val protocol: JetWhaleMethodHostPluginProtocol<Event, Method, MethodResult>
     ...
     */
    @Composable
    public abstract fun Content(context: JetWhaleMethodDebugOperationContext<Method, MethodResult>)
    ...
    final override fun ContentRaw(context: JetWhaleRawDebugOperationContext) {
        val typedContext = object : JetWhaleMethodDebugOperationContext<Method, MethodResult> {
