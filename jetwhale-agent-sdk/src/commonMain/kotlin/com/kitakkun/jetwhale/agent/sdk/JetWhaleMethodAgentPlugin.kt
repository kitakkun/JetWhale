...
/**
 * Method-based plugin which runs on the debug-target app.
 * Supports request-response communication via Method and MethodResult types.
 *
 * For simple bidirectional fire-and-forget event communication, use [JetWhaleAgentPlugin] instead.
 */
@OptIn(InternalJetWhaleApi::class)
public abstract class JetWhaleMethodAgentPlugin<Event, Method, MethodResult> : JetWhaleRawAgentPlugin() {
    /**
     * The protocol used for encoding and decoding messages.
     */
    protected abstract val protocol: JetWhaleMethodAgentPluginProtocol<Event, Method, MethodResult>
