...
jetwhalePlugin {
    ...
    pluginArchiveName.set("jetwhale-main-thread-monitor")
}
...
jetwhalePublish {
    ...
    name = "JetWhale Main Thread Monitor"
    description = "JetWhale host plugin that shows what blocks an app's main thread."
}
