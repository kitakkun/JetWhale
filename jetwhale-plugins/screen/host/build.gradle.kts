...
jetwhalePlugin {
    ...
    pluginArchiveName.set("jetwhale-screen-stream")
}
...
jetwhalePublish {
    artifactId = "jetwhale-screen-stream"
    name = "JetWhale Screen Stream"
    description = "JetWhale host plugin that shows an app's screen, streamed from inside the app."
}
