...
jetwhalePlugin {
    ...
    pluginArchiveName.set("jetwhale-debug-actions")
}
...
jetwhalePublish {
    ...
    name = "JetWhale Debug Actions"
    description = "JetWhale host plugin for running the debug actions an app registers."
}
