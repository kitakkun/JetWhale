...
jetwhalePlugin {
    ...
    pluginArchiveName.set("jetwhale-background-work")
}
...
jetwhalePublish {
    ...
    name = "JetWhale Background Work"
    description = "JetWhale host plugin for inspecting, cancelling and running an app's scheduled background work."
}
