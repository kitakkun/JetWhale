...
internal class DeleteFileEntryCommand(
    ...
    override val description =
        "Deletes a file, or a directory with everything in it, from the app's storage — to clear a cache or reset the app's state. It " +
            "cannot be undone, and a root itself cannot be deleted."
