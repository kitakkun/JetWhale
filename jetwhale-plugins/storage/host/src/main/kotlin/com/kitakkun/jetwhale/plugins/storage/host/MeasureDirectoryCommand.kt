...
internal class MeasureDirectoryCommand(
    ...
    override val description =
        "Adds up a directory of the app's storage and everything below it: the total size in bytes and how many files and directories it holds — how big a cache has grown, say. Symbolic links are counted but not followed. A very large tree is cut off, and then truncated is true and the totals are a floor."
