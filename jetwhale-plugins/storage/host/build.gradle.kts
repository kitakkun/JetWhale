...
jetwhalePlugin {
    ...
    pluginArchiveName.set("jetwhale-storage-inspector")
}
...
jetwhalePublish {
    ...
    name = "JetWhale Storage Inspector"
    description = "JetWhale host plugin for browsing an app's files and key-value stores."
}
