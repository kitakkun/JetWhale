...
internal class PressButtonCommand(
    ...
    override val description = "Presses a hardware button on the device. Android supports all buttons; the iOS simulator supports HOME and POWER (BACK and volume buttons fail there)."
