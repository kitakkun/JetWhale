 ...
 *
 * @property canInstallInApp Whether the OS update mechanism can be triggered from inside the app
 * (false on Linux, in dev runs, and in uber-jar runs — those fall back to the download page).
 */
