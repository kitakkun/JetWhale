...
@PublishedApi
internal data class Quintuple<out A, out B, out C, out D, out E>(
    val first: A,
    val second: B,
    val third: C,
    val fourth: D,
...
@PublishedApi
internal inline fun <T1, T2, T3, T4, T5, R> Reply.Companion.combine(
    r1: Reply<T1>,
    r2: Reply<T2>,
    r3: Reply<T3>,
    r4: Reply<T4>,
    ...
    r1.isNone || r2.isNone || r3.isNone || r4.isNone || r5.isNone -> none()
    else -> some(transform(r1.getOrThrow(), r2.getOrThrow(), r3.getOrThrow(), r4.getOrThrow(), r5.getOrThrow()))
}
...
inline fun <T1, T2, T3, T4, T5> Await(
    ...
    crossinline content: @Composable (T1, T2, T3, T4, T5) -> Unit,
) {
