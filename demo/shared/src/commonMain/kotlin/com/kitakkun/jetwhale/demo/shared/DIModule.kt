...
import com.kitakkun.jetwhale.plugins.mainthread.agent.JetWhaleMainThreadAgentPlugin
...
object DIModule {
    ...
    val mainThreadAgentPlugin: JetWhaleMainThreadAgentPlugin by lazy(::JetWhaleMainThreadAgentPlugin)
