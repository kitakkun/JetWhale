...
object DIModule {
    ...
    val coroutineInspectorAgentPlugin: JetWhaleCoroutineInspectorAgentPlugin by lazy { JetWhaleCoroutineInspectorAgentPlugin() }

    val coroutineDemo: CoroutineDemo by lazy { CoroutineDemo(coroutineInspectorAgentPlugin) }
